...
future scenarios that may affect Londoners’ participation in sport, physical activity and volunteering.
We are particularly interested in how demographic, environmental and behavioural factors interact
across London’s boroughs.

Using machine learning techniques, we invite students to explore correlations between demographic
characteristics, activity levels (e.g., proportion of individuals undertaking 150+ minutes of physical
activity per week), volunteering trends and types of sport participation using data from Sport England's
Active Lives Survey. The final outputs should support London Sport in anticipating likely patterns over
the next ten years.
